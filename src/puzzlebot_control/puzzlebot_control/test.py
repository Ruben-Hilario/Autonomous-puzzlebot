...
class OpenLoopCtrl(Node):
    def __init__(self):
        ...
        self.state = 0  # 0: rotate, 1: forward, 2: rotate_back, 3: stop
        self.state_start_time = self.get_clock().now()

        # Current position and waypoints
        self.x = 0.0
        self.y = 0.0
        self.waypoints = [(1.0, 1.0), (1.0, 0.0), (0.5,0.5), (0,0)]  # List of waypoints to visit
    ...
    def update_movement_parameters(self):
        ...
        if self.current_waypoint_index < len(self.waypoints):
            ...
            self.rotate_time = abs(self.angle/2) / self.angular_speed
        ...
        if self.state == 0:
            ...
            if elapsed_time >= self.forward_time:
                ...
                if self.current_waypoint_index < len(self.waypoints):
                    ...
                    self.state = 3  # All waypoints reached
                    self.state_start_time = now
